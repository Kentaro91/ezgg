  ...
  { type: 'act-header', actTitle: '액트 1' },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        content:
          '차가운 평야 → 바위 벌판(웨이포인트 확보) → 지하통로 → 어둠 숲.\n\n① 어둠 숲에서 이니프스의 나무 → 두루마리 획득 (웨이포인트 확보)\n② 두루마리를 아카라에게 → 돌기둥 순서 해독\n③ 바위 벌판 돌기둥 서클에서 순서대로 클릭 → 트리스트럼 포탈 개방\n④ 트리스트럼에서 케인 우리 클릭 → 구출\n\n길찾기:\n- 지하통로 1층: 왼쪽 벽 따라가기 → 2층 출구 → 어둠 숲\n- 어둠 숲: 지형 경계 따라가면 나무 발견\n\n보상: 케인 식별 무료',
      },
      ...(diff === 'normal'
        ? [
            {
          ...
          : [
              {
                ...
                title: '잊힌탑 타워런',
                content:
                  '검은 습지 → 잊힌탑. 헬 카운테스: 고급 룬 드랍 가능 (Ist까지).\n여유 있으면 돌려볼 만함. 길찾기는 동일: 좌회전 규칙.',
              },
            ]),
      ...(diff === 'normal'
        ? [
  ...
  { type: 'act-header', actTitle: '액트 2' },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        badgeColor: 'magic',
        tags: [{ label: '맵', type: 'map' }],
        title: '매마른 언덕 → 망자의 전당 (호라트릭 큐브)',
        content:
          '루트 골레인 → 바위투성이 황무지 → 매마른 언덕(웨이포인트 확보).\n매마른 언덕에서 망자의 전당 입구 발견.\n\n망자의 전당 (3층):\n- 1층: 벽 따라가기 → 계단\n- 2층: 웨이포인트 있음\n- 3층: 황금상자에서 호라트릭 큐브 획득\n\n길찾기: 세 갈래 → 가운데 기준 왼쪽. (액트2 던전 공통)',
      },
      {
        badge: '3',
        badgeColor: 'magic',
        ...
        title: '망자의 전당 동선 팁',
        content:
          '망자의 전당 입구 앞 포탈 → 매마른 언덕에서 머나먼 오아시스까지 이동 → 웨이포인트 확보 → 마을 → 포탈로 복귀.\n동선 절약의 핵심!',
      },
      {
        badge: '4',
        badgeColor: 'magic',
        tags: [{ label: '퀘스트', type: 'quest' }],
        title: '구더기 굴 (Maggot Lair) → 직원 상부',
        content:
          '머나먼 오아시스(웨이포인트 확보) → 구더기 굴 입구.\n\n구더기 굴 (3층) — D2R 악명 높은 던전:\n- 통로가 매우 좁음 (1명만 통과)\n- 1,2층: 우회전 경향\n- 3층: 1시 방향 확정\n- 3층 황금상자: 직원 상부(Staff of Kings) 획득\n\n팁: 갈림길에서 더 넓은 통로 선택 → 올바른 경로일 확률↑',
      },
      {
        badge: '5',
        badgeColor: 'magic',
        tags: [{ label: '퀘스트', type: 'quest' }],
        title: '발톱 독사 사원 (Claw Viper Temple) → 바이퍼 부적',
        content:
          '머나먼 오아시스 → 잊힌 도시(웨이포인트 확보) → 뱀의 골짜기 → 발톱 독사 사원.\n\n발톱 독사 사원 (2층):\n- 1층: 중간 크기. 계단 찾기\n- 2층: 매우 작음. 중앙 성소 파괴 → 태양 퀘스트 완료 + 바이퍼 부적 획득\n\n⚠ 2층 몬스터 밀집 → 진입 시 주의!',
      },
      ...(diff === 'normal'
        ? [
            {
  ...
  { type: 'act-header', actTitle: '액트 3' },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        badgeColor: 'magic',
        tags: [{ label: '맵', type: 'map' }],
        title: '거대습지 → 약탈자 밀림 (Flayer Jungle)',
        content:
          '거미숲 → 거대습지 → 약탈자 밀림.\n⚠ 거대습지↔약탈자 밀림 떨어진 경우 있음 → 거미숲에서 바로 약탈자 밀림 연결되기도 함.\n\n약탈자 밀림에서:\n- 약탈자 소굴(Flayer Dungeon) 입구 찾기\n- 지브딘(Gidbinn) 단검: 불타는 제단 근처 유니크 처치 후 획득 → 오차에게 반환\n\n웨이포인트 확보.',
      },
      {
        badge: '5',
        badgeColor: 'magic',
        tags: [{ label: '퀘스트', type: 'quest' }],
        title: '약탈자 소굴 (Flayer Dungeon) → 칼림의 뇌',
        content:
          "약탈자 소굴 (3층):\n- 1,2층: 좌회전 경향. 비교적 작은 맵\n- 3층: 황금상자에서 칼림의 뇌(Khalim's Brain) 획득\n\n⚠ 약탈자(Flayer)+샤먼 밀집 → 원거리 공격 주의.",
      },
      {
        badge: '6',
        badgeColor: 'magic',
        tags: [{ label: '동선', type: 'map' }],
        title: '하부 쿠라스트 → 쿠라스트 시장 → 상부 쿠라스트',
        content:
          '약탈자 밀림 → 하부 쿠라스트(웨이포인트 확보) → 쿠라스트 시장(웨이포인트 확보) → 상부 쿠라스트(웨이포인트 확보).\n\n쿠라스트 시장/상부 쿠라스트의 사원 6개 중:\n- 폐허 사원(Ruined Temple): 라의 태양석 → 알코어에게 반환 (스탯 +5)\n\n하수도 입구: 상부 쿠라스트 또는 바자에 위치.',
      },
      {
        badge: '7',
        badgeColor: 'magic',
      ...
      },
      {
        ...
        badgeColor: 'magic',
        tags: [{ label: '퀘스트', type: 'quest' }],
        title: '트라빈칼 (Travincal) → 칼림의 의지',
        content:
          '상부 쿠라스트 → 트라빈칼(웨이포인트 확보).\n\n하이 카운슬 3인 처치 → 칼림의 연장(Flail) 드롭.\n호라트릭 큐브에 눈+뇌+심장+연장 → 칼림의 의지 조합.\nCompelling Orb를 칼림의 의지로 파괴 → 증오의 억류지 진입.\n\n' +
          (diff === 'hell'
    ...
    steps: [
      {
        ...
        content:
          '혼돈의 요새 → 평원 외곽(Outer Steppes) → 절망의 평원.\n\n평원 외곽: 거의 직선. 빠르게 통과.\n\n절망의 평원에서 이즈엘(Izual) 배회 중. 파란색 타락 천사.\n처치 → 보상: 스킬 포인트 +2.\n\n길찾기: 맵이 넓음. 7시, 5시, 1시 중 랜덤.\n왼쪽(7시) 먼저 → 오른쪽(1시, 5시) 확인.',
      },
      {
        badge: '2',
        badgeColor: 'magic',
        tags: [{ label: '맵', type: 'map' }],
        title: '저주받은 자들의 도시 (City of the Damned)',
        content:
          '절망의 평원 → 저주받은 자들의 도시(웨이포인트 확보).\n\n다리와 플랫폼으로 연결된 구조.\n사각형 꼭짓점(11시/5시/7시/1시)에 다음 길.\n한쪽 벽 따라가기 → 불길의 강으로 내려가는 계단 발견.',
      },
      {
        badge: '3',
        badgeColor: 'magic',
        ...
        ? [
            {
              ...
              title: 'Lv.25 경험치 페널티',
              content:
                '25 미만이면 액트3 트라빈칼/약탈자 밀림에서 레벨링. Lv.24에 텔포봉 장착.',
            },
          ]
        : []),
      {
        ...
        content:
          '하로가스 → 핏빛 언덕(Bloody Foothills). 거의 직선 내리막.\n끝에서 센크(Shenk) 처치.\n\n⚠ 투석기 근처 폭발 데미지 주의!\n보상: 라르주크 소켓 추가 (아이템 1개) — 아끼는 장비에 사용!',
      },
      {
        badge: '2',
        badgeColor: 'magic',
        ...
        content:
          '핏빛 언덕 → 혹한의 고산지(Frigid Highlands, 웨이포인트 확보).\n울타리 3곳에 각 5명씩 포로 → 총 15명 구출.\n\n길찾기: 언덕과 다리 구조. 다리 건너며 진행.\n보상: 탈+랄+오르트 룬 (고대인의 서약 룬워드 가능)',
      },
      {
        badge: '3',
        badgeColor: 'magic',
        tags: [{ label: '맵', type: 'map' }],
        title: '아리앗 고원 → 수정 동굴 → 얼어붙은 강 (아냐 구출)',
        content:
          '혹한의 고산지 → 아리앗 고원(Arreat Plateau, 웨이포인트 확보) → 수정 동굴(Crystalline Passage, 웨이포인트 확보).\n\n수정 동굴에서 얼어붙은 강(Frozen River) 분기:\n- 직선적 구조. 강 따라 진행 → 아냐 발견\n- 마을의 말라에게 보고 → 아냐 구출 완료\n\n보상: 올레지 두루마리 + 이름 새기기\n(저항 보너스: 노말+10, 나이트메어+5, 헬+0)\n\n길찾기: 수정 동굴는 벽 따라가기 유효. Frozen River 입구와 Glacial Trail 출구는 서로 다른 방향.',
      },
      {
        badge: '4',
        badgeColor: 'magic',
